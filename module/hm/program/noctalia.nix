...
#
# settings 为从 noctalia 设置界面导出的全量配置，逐字嵌入下方 TOML 字符串。
  ...
  programs.noctalia = {
    ...
    settings = ''
      ...
      order = [ "main" ]
          ...
          [bar.main]
          auto_hide = false
          background_opacity = 0.43999999761581421
          border = "tertiary"
          border_width = 0.0
          capsule = false
          ...
          enabled = true
          end = [ "clock", "network", "tray", "notifications", "battery", "volume", "control-center", "session" ]
